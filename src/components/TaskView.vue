...
const tasks: Task[] = [
  ...
  { title: '开会：项目进度同步', category: '工作', date: '今天', time: '10:00', completed: false, isStarred: false },
  { title: '回复客户邮件', category: '工作', date: '今天', completed: true, isStarred: false },
  { title: '学习 React 新特性', category: '学习', date: '明天', completed: false, isStarred: false },
  { title: '阅读《设计模式》第三章', category: '学习', date: '明天', completed: false, isStarred: false },
  { title: '去健身房锻炼', category: '健康', date: '6月2日', completed: false, isStarred: false, isRecurring: true },
  { title: '超市采购生活用品', category: '生活', date: '6月2日', completed: false, isStarred: false },
  ...
  { title: '每日阅读 30 分钟', category: '学习', date: '5月30日', completed: true, isStarred: false },
  { title: '喝 8 杯水', category: '健康', date: '5月30日', completed: true, isStarred: false, isRecurring: true },
    ...
    <div class="px-8 pt-8 pb-4">
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-6">
          <button class="flex items-center gap-2 text-sm text-[#4a4a68] hover:text-[#4f6ef7] transition-colors">
      ...
      <div class="bg-white rounded-xl border border-[#ebeef5] shadow-sm mb-3">
        <div class="flex items-center gap-3 px-5 py-3.5">
          <svg class="w-5 h-5 text-[#d0d3dd] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
